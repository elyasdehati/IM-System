         ...
         <div class="card">
            <div class="row">
               <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="name" placeholder="Enter Name" class="form-control" value="{{ $editData->name }}">  
               </div>
               <div class="col-md-6 mb-3">
                  <label class="form-label">Code: <span class="text-danger">*</span></label>
                  <input type="text" name="code" class=" form-control" placeholder="Enter Code" value="{{ $editData->code }}">
            ...
            @if (isset($editData) && $editData->images->count() > 0)
                @foreach ($editData->images as $img)
                    <div class="col-md-3 mb-2">
                        ...
                        <div class="form-chich mt-1">
                            <input type="checkbox" class="form-chich-input" name="remove_image[]" value="{{ $img->id }}" id="remove_image_{{ $img->id }}">
                            <label for="remove_image_{{ $img->id }}" class="form-chech-label">Remove</label>
                        </div>
