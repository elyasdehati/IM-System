 ...
 <div class="col-xl-12">
  ...
  <div class="row">
     <div class="col-md-12">
        ...
        {{-- purchaseItems is in the Purchase Model --}}

            @foreach ($editData->purchaseItem as $item) 
            ...
            <tr data-id={{ $item->id }}>
               ...
               <td class="d-flex align-items-center gap-2">
                  ...
                  <button type="button" class="btn btn-primary btn-sm edit-discount-btn" data-id="{{ $item->id }}" data-name="{{ $item->product->name }}" data-cost="{{ $item->net_unit_cost }}" data-bs-toggle="modal" data-bs-target="#discountModal">
             ...
             <table class="table border">
                <tbody>
                   <tr>
                      ...
                      <td class="py-3" id="displayDiscount">AFN {{ $editData->discount }}</td>
                   </tr>
                   <tr>
                      <td class="py-3">Shipping</td>
                      <td class="py-3" id="shippingDisplay">AFN {{ $editData->shipping }}</td>
                   </tr>
                   <tr>
         ...
         <div class="col-md-4">
            <div class="form-group w-100">
               ...
               <select name="status" id="status" class="form-control form-select">
                  ...
                  <option value="Recieved" {{ $editData->status == 'Recieved' ? 'selected' : ''  }} >Recieved</option>
