...
<html lang="en">
    ...
    <form method="POST" action="{{ route('register') }}" class="my-4">
        ...
        <div class="form-group mb-3">
            ...
            <input class="form-control" type="password" required="" id="password" name="password_confirmation" placeholder="Enter your Password">
        </div>

         <div class="form-group mb-3">
            <label for="password" class="form-label">Contfirm Password</label>
            <input class="form-control" type="password" required="" id="password_confirmation" name="password" placeholder="Enter your Contfirm Password">
        </div>
